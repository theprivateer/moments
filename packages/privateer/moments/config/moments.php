...
return [
    ...
    */
    ...
    | web UI routes and API routes. Disable either surface if the host app
    | only needs part of the package functionality.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The web route prefix controls where the package UI is mounted in the
    | host application. The package defaults to "moments", which produces
    | URLs such as "/moments" and "/moments/{moment}".
    |
    | The API prefix controls the base segment above the versioned API
    | routes, which defaults to "api" and produces "/api/v1/..." URLs.
    |
    */
    'route_prefix' => env('MOMENTS_ROUTE_PREFIX', 'moments'),
    ...
    */
    ...
    | This prevents unauthorized manipulation of image parameters. Generate
    ...
    */
    ...
    | value is passed directly to Laravel's validation "max" rule. The
    | default of 2048 permits files up to 2 MB.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Optional Markdown text prepended to the public timeline. Leave blank
    | or unset to show no introduction. Raw HTML and unsafe links are
