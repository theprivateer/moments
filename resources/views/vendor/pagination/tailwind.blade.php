                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-white bg-gray-900 border border-gray-900 cursor-default leading-5">{{ $page }}</span>
                                    </span>
                                @else
